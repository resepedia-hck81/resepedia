    ...
    <div>
      <div className="text-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">
          Generate Recipe by Name or Description
        </h2>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Enter a recipe name or describe a recipe to find the perfect dish for
          your next meal!
        </p>
      </div>
      {!showSearchResult ? (
          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative mb-6">
              <input
                ...
                placeholder="e.g. 'Classic margherita pizza' or 'Cheesy oven-baked pizza with tomato sauce'"
                value={searchQuery}
        ...
        <div className="mt-8">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <GenerateResult
              recommendedRecipes={searchResults}
              activeRecipeTab={activeSearchRecipeTab}
            />
            {/* Reset Search Button */}
